...
from redis_video_stream.tasks import CeleryTaskManager, get_video_stream_info
...
def main():
    ...
    task = CeleryTaskManager.yolo_image_stream.delay(
        redis_url=redis_url,
        read_stream_key="camera:0",
        write_stream_key="ai:0",
        modelname="yolov5s6",
        conf=0.6,
    )
    ...
    task = CeleryTaskManager.cv_resize_stream.delay(
        redis_url=redis_url,
        read_stream_key="ai:0",
        write_stream_key="resize:0",
        w=192,
        h=108,
    )
